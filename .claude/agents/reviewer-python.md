...
- Behaviour documented as physically correct in the `CLAUDE.md` gotchas — residual pitch/roll
...
Per the parallelisation policy in `CLAUDE.md`: a PR touching both Python and `ui/` gets this
