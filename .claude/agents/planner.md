...
[`CLAUDE.md`](../../CLAUDE.md) at the repository root is **binding**. Read it before you design
...
### 9. Parallelisation
What can proceed concurrently and what must not, following the policy in `CLAUDE.md`:
