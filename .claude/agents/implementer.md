...
[`CLAUDE.md`](../../CLAUDE.md) at the repository root is **binding**. Read it before you write
...
2. Read the approved design: `docs/designs/<feature>.md`. **It is your specification.** If the
   design is missing, incomplete, or contradicts `CLAUDE.md`, **stop and report** — ask for a
...
These are the exact commands from `CLAUDE.md`. Run them locally and make them pass. A task is not
