...
class XPlaneSimAdapter:
    ...
    #
    # Refusing stubs (docs/designs/weather-manager.md D16, docs/designs/
    # fuel-payload.md D15): can_set_weather/can_set_fuel_payload stay False on
    # this adapter, and every method below raises immediately. Real dataref
    # mapping is each manager's own later adapter track.
