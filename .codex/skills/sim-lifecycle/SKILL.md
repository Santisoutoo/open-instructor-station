...
`AGENTS.md` rule 1 says the app is 100% external and the user never opens or launches anything
...
validation run it is specified in `.codex/agents/sim-validator.md`. `tests/conftest.py` has its
